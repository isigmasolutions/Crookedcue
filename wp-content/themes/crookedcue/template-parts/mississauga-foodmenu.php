...
<ul class="mississauga-menu">
<?php

$testimoniallist = new WP_Query('posts_per_page=-1&post_type=mississauga_menu&orderby=menu_order&order=ASC');
...
?>
        ...
        <div id="<?php the_id();?>" class="panel panel-default">
