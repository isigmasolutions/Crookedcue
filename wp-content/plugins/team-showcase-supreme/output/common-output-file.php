...
jQuery(document).ready(function() {
  /*
  setTimeout(function(){
    jQuery(".wpm_main_template").find('img').removeAttr("data-src");
    jQuery(".wpm_main_template").find('img').removeAttr("loading");
  }, 500);  
  
   setTimeout(function(){
    jQuery(".wpm_main_template").find('img').removeAttr("class");
  }, 1000);
...
.wpm-6310-col-2:nth-child(2n),
.wpm-6310-col-3:nth-child(3n),
.wpm-6310-col-4:nth-child(4n),
.wpm-6310-col-5:nth-child(5n),
.wpm-6310-col-6:nth-child(6n) {
  margin-right: 0;
}
...
<?php if ($allSlider[0]) { ?>#wpm-6310-slider-<?php echo $ids ?> .wpm-6310-owl-nav div {
    position: absolute;
  ...
  #wpm-6310-slider-<?php echo $ids ?> .wpm-6310-owl-nav div.wpm-6310-owl-next {
    <?php if (isset($styleTemplate) && ($styleTemplate==1 || $styleTemplate==3 || $styleTemplate==4 || $styleTemplate==5 || $styleTemplate==6 || $styleTemplate==7 || $styleTemplate==8 || $styleTemplate==9 || $styleTemplate==10)) {
  ...
  #wpm-6310-slider-<?php echo $ids ?> .wpm-6310-owl-nav div.wpm-6310-owl-prev i[class*="fa-"],
  #wpm-6310-slider-<?php echo $ids ?> .wpm-6310-owl-nav div.wpm-6310-owl-next i[class*="fa-"] {
    color: <?php echo $allSlider[8] ?>;
    top: 0;
...
jQuery(document).ready(function(e) {
  ...
  if ($allSlider[0]) {
    ...
    owlVar.tss6310OwlCarousel({
      ...
      navText: ["<i class='<?php echo $allSlider[4] ?>-left'></i>",
        "<i class='<?php echo $allSlider[4] ?>-right'></i>"
      ],
      responsive: {
        0: {
          items: 1
