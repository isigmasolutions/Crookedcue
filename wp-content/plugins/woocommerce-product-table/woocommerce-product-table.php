...
final class WC_Product_Table_Plugin {
    ...
    private function includes() {
        ...
        // License
        require_once $plugin_path . 'license/class-b2-plugin-license.php';
        ...
        if ( $this->is_front_end() ) {
            require_once $plugin_path . 'lib/class-html-data-table.php';
            require_once $plugin_path . 'lib/class-wp-scoped-hooks.php';
        ...
        // Admin
        if ( is_admin() ) {
            require_once $plugin_path . 'lib/class-wc-settings-additional-field-types.php';
