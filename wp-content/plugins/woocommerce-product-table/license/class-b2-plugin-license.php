...
if ( ! class_exists( 'Barn2_Plugin_License' ) ) {
    ...
    class Barn2_Plugin_License {
        ...
        public function get_license_key_admin_message() {
            ...
            $deactivate_button = sprintf( '<button type="submit" class="button b2-license-button" name="deactivate_key" value="%1$s" style="margin-left:8px;">%2$s</button>', esc_attr( $this->license_key_option ), __( 'Deactivate', 'woocommerce-product-table' ) );
