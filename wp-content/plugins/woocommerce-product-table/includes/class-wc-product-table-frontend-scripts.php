...
class WC_Product_Table_Frontend_Scripts {
    ...
    public static function register_scripts() {
        ...
        wp_register_script( 'jquery-serialize-object-macek', WCPT_Util::get_asset_url( "js/jquery-serialize-object/jquery.serialize-object{$suffix}.js" ), array(
            'jquery' ), '2.5', true );


        wp_register_script( self::SCRIPT_HANDLE, WCPT_Util::get_asset_url( "js/wc-product-table{$suffix}.js" ), array( 'jquery-data-tables', 'jquery-blockui',
            'jquery-serialize-object-macek' ), self::SCRIPT_VERSION, true );
