	...
	class Sinatra_Options {
		...
		public function get_defaults() {
			...
			$defaults = array(
				...
				'sinatra_tsp_header_condition'             => 'auto-decide',
				'sinatra_tsp_header_archive'               => false,
				'sinatra_tsp_header_404'                   => false,
				'sinatra_tsp_header_blog'                  => true,
				'sinatra_tsp_header_posts'                 => true,
				'sinatra_tsp_header_pages'                 => true,
				'sinatra_tsp_header_devices'               => 'all',
				'sinatra_tsp_header_display_heading'       => true,
				...
				'sinatra_page_header_background'           => sinatra_design_options_defaults(
					array(
						'background' => array(
							'color'    => array( 'background-color' => 'rgba(0,0,0,0.05)' ),
							'gradient' => array(),
							'image'    => array(),
						),
					)
