		...
		<div class="author-box-content"<?php sinatra_schema_markup( 'description' ); ?>>
			...
			if ( '' === $sinatra_author_description ) {
				if ( $sinatra_current_user_id && $sinatra_author_id === $sinatra_current_user_id ) {
					...
					printf( wp_kses_post( __( 'You haven&rsquo;t entered your Biographical Information yet. %1$sEdit your Profile%2$s now.', 'sinatra' ) ), '<br/><a href="' . esc_url( get_edit_user_link( $sinatra_current_user_id ) ) . '">', '</a>' );
				}
			} else {
